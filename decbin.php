...
body{
 ...
 <body > 
   ...
   <p style="text-align: center;">Enter a decimal number you want to convert to binary number</p> 
   <p style="text-align: center;"> <b>Decimal to Binary:<b> </p>
   <p style="text-align:center;"> DECIMAL= <?php echo $_POST["decimal"];?> </p>
   <p style="text-align:center;"> <?php 
   echo "BINARY= ";
   echo base_convert($_POST["decimal"],10,2);
?>   <b>[THE ANSWER]</b></p> <br>
