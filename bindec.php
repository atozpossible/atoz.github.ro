...
body{
 ...
 <body > 
   ...
   <p style="text-align: center;">Enter a binary number you want to convert to decimal</p> 
   <p style="text-align: center;"> <b>Binary to Decimal:<b> </p>
   <p style="text-align:center;"> BINARY= <?php echo $_POST["binary"];?> </p>
   <p style="text-align:center;"> <?php 
   echo "DECIMAL= ";
   echo base_convert($_POST["binary"],2,10);
?>   <b>[THE ANSWER]</b></p> <br><br><br>
