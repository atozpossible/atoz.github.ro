...
body{
 ...
 <body > 
   ...
   <p style="text-align: center;">Enter an hexadecimal number you want to convert into octal number.</p> 
   <p style="text-align: center;"> <b>Hexadecimal to Octal:<b> </p>
   <p style="text-align:center;"> HEXADECIMAL= <?php echo $_POST["hexadecimal"];?> </p>
   <p style="text-align:center;"> <?php 
   echo "OCTAL= ";
   echo base_convert($_POST["hexadecimal"],16,8);
