...
body{
 ...
 <body > 
   ...
   <p style="text-align: center;">Enter a binary number you want to convert to octal</p> 
   <p style="text-align: center;"> <b>Binary to Octal:<b> </p>
   <p style="text-align:center;"> BINARY= <?php echo $_POST["binary"];?> </p>
   <p style="text-align:center;"> <?php 
   echo "OCTAL= ";
   echo base_convert($_POST["binary"],2,8);
?>   <b>[THE ANSWER]</b></p> <br>
