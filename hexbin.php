...
body{
 ...
 <body > 
   ...
   <p style="text-align: center;">Enter a hexadecimal number you want to convert into a binary number</p> 
   <p style="text-align: center;"> <b>Hexdecimal to Binary:<b> </p>
   <p style="text-align:center;"> HEXADECIMAL= <?php echo $_POST["hexadecimal"];?> </p>
   <p style="text-align:center;"> <?php 
   echo "BINARY= ";
   echo base_convert($_POST["hexadecimal"],16,2);
